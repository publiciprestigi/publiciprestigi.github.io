...
A les taules de cada festival, s'indica amb el símbol ★ els premis obtinguts, si apareix al Top 100 d'espectadors de la Part I (posició global, la posició dins la dècada corresponent, i el nombre d'espectadors acumulats segons les xifres oficials de l'ICAA (que com succeeix a la primera part, parteixen de l'última setmana de febrer del 2026).
