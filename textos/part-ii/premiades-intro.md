<!-- intro -->
Recull cronològic de tots els premis obtinguts a les seccions oficials competitives dels quatre festivals (Cannes, Berlín, Venècia i Sant Sebastià), organitzat per dècades.
...
- **Palma d'Or (Cannes): 0.** En el període analitzat, amb 28 films seleccionats i 12 premis de tota classe, el màxim guardó del festival considerat de més prestigi continua escapant-se (l'únic precedent és *Viridiana* de Luis Buñuel l'any 1961).
...
- **Lleó d'Or (Venècia): 1.** *La habitación de al lado* (Pedro Almodóvar, 2024). Primer i únic Lleó d'Or de la història del cinema espanyol, i ben recent.
