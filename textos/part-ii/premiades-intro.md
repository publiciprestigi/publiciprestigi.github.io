...
<div style="display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin:20px 0 4px">
  ...
  <div style="background:#fdf3d0;border-radius:6px;padding:16px 12px;text-align:center">
    ...
    <div style="font-size:12px;color:#555;line-height:1.4"><strong><em>Deprisa, deprisa</em></strong> (1981) de Carlos Saura, <strong><em>La colmena</em></strong> (1983) de Mario Camus i <strong><em>Alcarràs</em></strong>(2022) de Carla Simón</div>
  </div>
  <div style="background:#fdf3d0;border-radius:6px;padding:16px 12px;text-align:center">
    ...
    <div style="font-size:12px;color:#555;line-height:1.4"><strong><em>La habitación de al lado</em></strong> (2024) de Pedro Almodóvar</div>
  </div>
  <div style="background:#fdf3d0;border-radius:6px;padding:16px 12px;text-align:center">
