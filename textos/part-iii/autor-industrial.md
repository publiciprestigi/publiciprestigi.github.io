<!-- intro -->
Hi ha una tercera categoria que l’estudi ha documentat en dades, però no ha nomenat explícitament: un cinema que no coincideix del tot ni amb el circuit de festivals de la Part II ni amb el cinema popular de consum de la Part I. Podríem anomenar-lo cinema d’autor industrial, com quan *Cahiers du Cinéma* parla de Hitchcock o Spielberg com a autors dins del sistema industrial. Dominen el llenguatge del gènere popular (terror, *thriller*, ciència-ficció, comèdia negra) amb una veu autoral reconeixible, treballen amb pressupostos grans i connecten amb el gran públic sense necessitar la validació dels festivals europeus.
