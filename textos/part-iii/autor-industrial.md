<!-- intro -->
Hi ha una tercera categoria que l’estudi ha documentat en dades, però no ha nomenat explícitament: un cinema que no coincideix del tot ni amb el circuit de festivals de la Part II ni amb el cinema popular de consum de la Part I. Podríem anomenar-lo cinema d’autor industrial, com quan *Cahiers du Cinéma* parla de Hitchcock o Spielberg com autors dins del sistema industrial. Dominen el llenguatge del gènere popular (terror, *thriller*, ciència-ficció, comèdia negra) amb una veu autoral reconeixible, treballen amb pressupostos grans i connecten amb el gran públic sense necessitar la validació dels festivals europeus.
...
Una pel·lícula que probablement hauria ocupat les primeres posicions del Top 100 en qualsevol altra dècada ara és invisible per a les mètriques tradicionals. El mercat ha canviat, però els sistemes de mesura encara no s’hi han adaptat. Les dades existeixen, però continuen majoritàriament en mans privades i no hi ha (encara) una unitat universal que permeti equiparar una entrada de cinema amb una visualització en una plataforma.
<!-- /paradoxa -->
